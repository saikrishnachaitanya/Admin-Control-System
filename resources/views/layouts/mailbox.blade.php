 ...
 <div class="mail-box">
                  <aside class="sm-side">
                      <div class="user-head"
                          ...
                          <div class="user-name">
                              <h5><a href="#">Admin MailBox</a></h5>
                              <span><a href="#">saichaitanya5960@gmail.com</a></span>
                          </div>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
        <form role="form" class="form-horizontal" method="POST" action="{{ url('mailbox') }}">
          {{ csrf_field() }}
                                              <div class="form-group">
                                                  <label class="col-lg-2 control-label">To</label>&nbsp<br>
                                                  <div class="col-lg-10">
                                                      <input type="text" placeholder="" name="email" id="email" class="form-control">
                                                  </div>
                                              </div>
                                              <div class="form-group">
                                                  <label class="col-lg-2 control-label">Subject</label>&nbsp
                                                  <div class="col-lg-10">
                                                      <input type="text" placeholder="" name="subject" id="subject" class="form-control">
                                                  </div>
                                              </div>
                                              <div class="form-group">
                                                  <label class="col-lg-2 control-label">Message</label>&nbsp
                                                  <div class="col-lg-10">
